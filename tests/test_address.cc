...
int main(int argc, char** argv) {
    test_ipv4();
    test_iface();
    auto addr = sylar::IPAddress::Create("240e:878:400:2911:10e4:166:909a:c231");
    SYLAR_LOG_INFO(g_logger) << *addr->broadcastAddress(48);
    SYLAR_LOG_INFO(g_logger) << *addr->broadcastAddress(47);
    SYLAR_LOG_INFO(g_logger) << *addr->networdAddress(64);
    SYLAR_LOG_INFO(g_logger) << *addr->networdAddress(63);
